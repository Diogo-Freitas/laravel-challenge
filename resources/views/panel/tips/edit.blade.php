...
@section('title', 'Panel - Editar Dicas')
...
@section('main')
    ...
    <form action="{{ route('panel.tips.update', $tip->id) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Editar Dica</h3>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select name="vehicle" class="form-control @error('vehicle') is-invalid @enderror" id="inputVehicle">
                                        ...
                                        @foreach ($vehicles as $vehicle)
                                            <option {{ old('vehicle', $tip->vehicle_id) == $vehicle->id ? 'selected' : '' }} value="{{ $vehicle->id }}">{{ __($vehicle->vehicle) }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="version" class="form-control @error('version') is-invalid @enderror" value="{{ old('version', $tip->version) }}" id="inputVersion">
                            ...
                            <div class="col-xl-12">
                                ...
                                <textarea name="tip" class="form-control @error('tip') is-invalid @enderror" rows="5" id="inputTip">{{ old('tip', $tip->tip) }}</textarea>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var OldVehicle = '{{ old('vehicle', $tip->vehicle_id) }}';
            if (OldVehicle !== '') {
            ...
            var OldBrand = '{{ old('brand', $tip->brand_id) }}';
            if (OldBrand !== '') {
                var brand = OldBrand;
